...
#### Request body
  ...
  | `channelAttributes` | string | yes |  channelAttributes. |  
  | `isMessageAutoAttachedToTicket` | bool | no |  Whether a message need to auto attached to ticket. |  
  | `timeToAutoAttachToTicket` | string | no |  Allowed values are "whenTheMessageIsSent", "whenContactRepliesTheMessage". |  
...
Outreach Message is represented as simple flat JSON objects with the following keys:
  ...
  | `channelAttributes` | [Channel Attributes Object](#outreach-channel-attributes-object) | no | extra info for message, such as email subject, reference key, etc. |  
...
Outbound Message is represented as simple flat JSON objects with the following keys:
  ...
  | `contactId` | Guid | no |  Contact id of the Outbound Message. |  
  | `message` | string | yes |  Message. |  
  | `channelAttributes` | [Outreach Channel Attributes](#outreach-channel-attributes-object) | yes | Channel attributes, such as email subject, reference |  
...
### Outreach Channel Attributes Object
Outreach channel attributes object is represented as simple flat JSON objects with the following keys:
...
MessageDelivery Object is represented as simple flat JSON objects with the following keys:
  ...
  ### Outbound Email Object
  Outbound Email Object is represented as simple flat JSON objects with the following keys:
